...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Eat the squares and don't hit your own tail!";
	...
	private void gameOver() {
		...
		int input = JOptionPane.showOptionDialog(null, "Do you want to play again?","Options", 0, -1, null,
				options, 0);
		if(input==0) {
